...
struct istream
{
  ...
  public:
    ...
    template <scalar_encoder encoder> void deserialize_as(auto &value, const field_attributes &field);

    template <size_t ordinal, typename T> void deserialize_variant(T &variant, const field_attributes &field);
