...
template <class T>
concept proto_field_bytes = container<T> && std::is_same_v<typename std::decay_t<T>::value_type, std::byte>;
...
template <class T>
concept proto_field_string = container<T> && std::is_same_v<typename std::decay_t<T>::value_type, char>;
