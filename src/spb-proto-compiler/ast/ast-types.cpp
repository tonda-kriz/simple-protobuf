...
[[nodiscard]] auto resolve_type(const search_ctx &self, const proto_field &field, size_t type_part)
    ...
    static constexpr auto type_map =
        std::array<std::pair<proto_field::Type, std::array<proto_field::BitType, 4>>, 15>{{
            {proto_field::Type::INT32,
             {{proto_field::BitType::INT8, proto_field::BitType::INT16, proto_field::BitType::INT32}}},
            ...
            {proto_field::Type::UINT32,
             {{proto_field::BitType::UINT8, proto_field::BitType::UINT16, proto_field::BitType::UINT32}}},
            {proto_field::Type::UINT64,
             {{proto_field::BitType::UINT8, proto_field::BitType::UINT16, proto_field::BitType::UINT32,
               proto_field::BitType::UINT64}}},
...
[[nodiscard]] auto get_scalar_type(const proto_file &file, const proto_field &field, size_t type_part)
    -> std::pair<proto_field::Type, proto_field::BitType>
{
    if (type_part != 0)
        return {};
...
[[nodiscard]] auto get_sub_message(const proto_message &message, const proto_field &field, size_t type_part)
    -> const proto_message *
{
...
[[nodiscard]] auto resolve_enum(const proto_message &message, const proto_field &field, size_t type_part)
    -> proto_field::Type
{
    ...
    return std::any_of(message.enums.begin(), message.enums.end(),
                       [type_name](const auto &enum_) -> bool { return type_name == enum_.name.proto_name; })
...
[[nodiscard]] auto resolve_from_parent(const search_ctx &self, const proto_field &field, size_t type_part)
    -> proto_field::Type
{
...
[[nodiscard]] auto resolve_from_imports(const search_ctx &self, const proto_field &field, size_t type_part)
    -> proto_field::Type
{
    if (type_part > 0)
        return proto_field::Type::NONE;
