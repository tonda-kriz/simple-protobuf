...
template <size_t N> auto operator==(const string &lhs, const array<byte, N> &rhs) noexcept -> bool
{
    return lhs.size() == rhs.size() && (memcmp(lhs.data(), rhs.data(), lhs.size()) == 0);
}
...
template <typename T> auto opt_size(const std::vector<T> &opt) -> std::size_t
{
    return opt.size();
}
...
template <typename T> auto enum_value(const T &value)
{
    return std::underlying_type_t<T>(value);
}

template <typename T> auto enum_value(const std::optional<T> &value)
{
...
template <typename GPB, typename SPB> void gpb_compatibility_array()
{
...
TEST_CASE("int")
{
    SUBCASE("varint8")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqInt8_1, Test::Scalar::ReqInt8_1, int8_t>(
                {-1, 0});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqInt8_2, Test::Scalar::ReqInt8_2, int8_t>(
                {-2, -1, 0, 1});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("varuint8")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqUint8_1, Test::Scalar::ReqUint8_1,
                                             uint8_t>({0, 1});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqUint8_2, Test::Scalar::ReqUint8_2,
                                             uint8_t>({0, 1, 2, 3});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("varint16")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqInt16_1, Test::Scalar::ReqInt16_1,
                                             int16_t>({-1, 0});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqInt16_2, Test::Scalar::ReqInt16_2,
                                             int16_t>({-2, -1, 0, 1});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("varuint16")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqUint16_1, Test::Scalar::ReqUint16_1,
                                             uint16_t>({0, 1});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqUint16_2, Test::Scalar::ReqUint16_2,
                                             uint16_t>({0, 1, 2, 3});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("varint32")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqInt32_1, Test::Scalar::ReqInt32_1,
                                             int32_t>({-1, 0});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqInt32_2, Test::Scalar::ReqInt32_2,
                                             int32_t>({-2, -1, 0, 1});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("varuint32")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqUint32_1, Test::Scalar::ReqUint32_1,
                                             uint32_t>({0, 1});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqUint32_2, Test::Scalar::ReqUint32_2,
                                             uint32_t>({0, 1, 2, 3});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("varint64")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqInt64_1, Test::Scalar::ReqInt64_1,
                                             int64_t>({-1, 0});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqInt64_2, Test::Scalar::ReqInt64_2,
                                             int64_t>({-2, -1, 0, 1});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("svarint8")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSint8_1, Test::Scalar::ReqSint8_1, int8_t>(
                {-1, 0});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSint8_2, Test::Scalar::ReqSint8_2, int8_t>(
                {-2, -1, 0, 1});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("svarint16")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSint16_1, Test::Scalar::ReqSint16_1,
                                             int16_t>({-1, 0});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSint16_2, Test::Scalar::ReqSint16_2,
                                             int16_t>({-2, -1, 0, 1});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("svarint32")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSint32_1, Test::Scalar::ReqSint32_1,
                                             int32_t>({-1, 0});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSint32_2, Test::Scalar::ReqSint32_2,
                                             int32_t>({-2, -1, 0, 1});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("svarint64")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSint64_1, Test::Scalar::ReqSint64_1,
                                             int64_t>({-1, 0});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSint64_2, Test::Scalar::ReqSint64_2,
                                             int64_t>({-2, -1, 0, 1});
        }
        SUBCASE("required")
        {
    ...
    SUBCASE("fixed32")
    {
        SUBCASE("bitfield")
        {
            ...
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed32_32_2,
                                             Test::Scalar::ReqFixed32_32_2, uint32_t>({0, 1, 2, 3});
        }
        SUBCASE("required")
        {
        ...
        SUBCASE("uint8")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed32_8_1,
                                                 Test::Scalar::ReqFixed32_8_1, uint8_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed32_8_2,
                                                 Test::Scalar::ReqFixed32_8_2, uint8_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqFixed32_8, Test::Scalar::ReqFixed32_8,
                                        uint8_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptFixed32_8, Test::Scalar::OptFixed32_8,
                                        uint8_t>();
            }
            SUBCASE("repeated")
            {
        ...
        SUBCASE("uint16")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed32_16_1,
                                                 Test::Scalar::ReqFixed32_16_1, uint16_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed32_16_2,
                                                 Test::Scalar::ReqFixed32_16_2, uint16_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqFixed32_16, Test::Scalar::ReqFixed32_16,
                                        uint16_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptFixed32_16, Test::Scalar::OptFixed32_16,
                                        uint16_t>();
            }
            SUBCASE("repeated")
            {
    ...
    SUBCASE("fixed64")
    {
        SUBCASE("bitfield")
        {
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed64_8_1, Test::Scalar::ReqFixed64_64_1,
                                             uint64_t>({0, 1});
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed64_8_2, Test::Scalar::ReqFixed64_64_2,
                                             uint64_t>({0, 1, 2, 3});
        }
        SUBCASE("required")
        {
        ...
        SUBCASE("uint8")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed64_8_1,
                                                 Test::Scalar::ReqFixed64_8_1, uint8_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed64_8_2,
                                                 Test::Scalar::ReqFixed64_8_2, uint8_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqFixed64_8, Test::Scalar::ReqFixed64_8,
                                        uint8_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptFixed64_8, Test::Scalar::OptFixed64_8,
                                        uint8_t>();
            }
            SUBCASE("repeated")
            {
        ...
        SUBCASE("uint16")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed64_16_1,
                                                 Test::Scalar::ReqFixed64_16_1, uint16_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed64_16_2,
                                                 Test::Scalar::ReqFixed64_16_2, uint16_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqFixed64_16, Test::Scalar::ReqFixed64_16,
                                        uint16_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptFixed64_16, Test::Scalar::OptFixed64_16,
                                        uint16_t>();
            }
            SUBCASE("repeated")
            {
        ...
        SUBCASE("uint32")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed64_32_1,
                                                 Test::Scalar::ReqFixed64_32_1, uint32_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqFixed64_32_2,
                                                 Test::Scalar::ReqFixed64_32_2, uint32_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqFixed64_32, Test::Scalar::ReqFixed64_32,
                                        uint32_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptFixed64_32, Test::Scalar::OptFixed64_32,
                                        uint32_t>();
            }
            SUBCASE("repeated")
            {
    ...
    SUBCASE("sfixed32")
    {
        SUBCASE("bitfield")
        {
            ...
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed32_32_2,
                                             Test::Scalar::ReqSfixed32_32_2, int32_t>({0, 1, 2, 3});
        }
        SUBCASE("required")
        {
        ...
        SUBCASE("int8")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed32_8_1,
                                                 Test::Scalar::ReqSfixed32_8_1, int8_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed32_8_2,
                                                 Test::Scalar::ReqSfixed32_8_2, int8_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqSfixed32_8, Test::Scalar::ReqSfixed32_8,
                                        int8_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptSfixed32_8, Test::Scalar::OptSfixed32_8,
                                        int8_t>();
            }
            SUBCASE("repeated")
            {
        ...
        SUBCASE("int16")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed32_16_1,
                                                 Test::Scalar::ReqSfixed32_16_1, int16_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed32_16_2,
                                                 Test::Scalar::ReqSfixed32_16_2, int16_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqSfixed32_16, Test::Scalar::ReqSfixed32_16,
                                        int16_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptSfixed32_16, Test::Scalar::OptSfixed32_16,
                                        int16_t>();
            }
            SUBCASE("repeated")
            {
    ...
    SUBCASE("sfixed64")
    {
        SUBCASE("bitfield")
        {
            ...
            gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed64_64_2,
                                             Test::Scalar::ReqSfixed64_64_2, int64_t>({0, 1, 2, 3});
        }
        SUBCASE("required")
        {
        ...
        SUBCASE("int8")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed64_8_1,
                                                 Test::Scalar::ReqSfixed64_8_1, int8_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed64_8_2,
                                                 Test::Scalar::ReqSfixed64_8_2, int8_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqSfixed64_8, Test::Scalar::ReqSfixed64_8,
                                        int8_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptSfixed64_8, Test::Scalar::OptSfixed64_8,
                                        int8_t>();
            }
            SUBCASE("repeated")
            {
        ...
        SUBCASE("int16")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed64_16_1,
                                                 Test::Scalar::ReqSfixed64_16_1, int16_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed64_16_2,
                                                 Test::Scalar::ReqSfixed64_16_2, int16_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqSfixed64_16, Test::Scalar::ReqSfixed64_16,
                                        int16_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptSfixed64_16, Test::Scalar::OptSfixed64_16,
                                        int16_t>();
            }
            SUBCASE("repeated")
            {
        ...
        SUBCASE("int32")
        {
            SUBCASE("bitfield")
            {
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed64_32_1,
                                                 Test::Scalar::ReqSfixed64_32_1, int32_t>({0, 1});
                gpb_compatibility_bitfield_value<Test::Scalar::gpb::ReqSfixed64_32_2,
                                                 Test::Scalar::ReqSfixed64_32_2, int32_t>({0, 1, 2, 3});
            }
            SUBCASE("required")
            {
                gpb_compatibility_value<Test::Scalar::gpb::ReqSfixed64_32, Test::Scalar::ReqSfixed64_32,
                                        int32_t>();
            }
            SUBCASE("optional")
            {
                gpb_compatibility_value<Test::Scalar::gpb::OptSfixed64_32, Test::Scalar::OptSfixed64_32,
                                        int32_t>();
            }
            SUBCASE("repeated")
            {
...
TEST_CASE("bytes")
{
    ...
    SUBCASE("repeated")
    {
        ...
        gpb_compatibility<Test::Scalar::gpb::RepBytes>(Test::Scalar::RepBytes{
            .value = {to_bytes("\x00\x01\x02\x03\x04"sv), to_bytes("\x00\x01\x02"sv), to_bytes("hello")}});
    }
    SUBCASE("fixed")
    {
        SUBCASE("required")
        ...
        SUBCASE("repeated")
        {
            ...
            gpb_compatibility<Test::Scalar::gpb::RepBytesFixed>(
                Test::Scalar::RepBytesFixed{.value = {to_array("12345678"), to_array("87654321")}});
        }
    }
}
TEST_CASE("enum")
