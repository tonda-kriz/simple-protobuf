...
namespace std
{
template <size_t S> auto operator==(const string &lhs, const ::etl::vector<byte, S> &rhs) noexcept -> bool
{
    return lhs.size() == rhs.size() && (memcmp(lhs.data(), rhs.data(), lhs.size()) == 0);
}
template <size_t S> auto operator==(const ::etl::string<S> &lhs, const string &rhs) noexcept -> bool
{
    return lhs.size() == rhs.size() && (memcmp(lhs.data(), rhs.data(), lhs.size()) == 0);
}
} // namespace std
...
template <typename T, size_t S> auto opt_size(const etl::vector<T, S> &opt) -> std::size_t
{
    return opt.size();
}
...
TEST_CASE("string")
{
    ...
    SUBCASE("repeated")
    {
        gpb_compatibility<Test::Etl::Scalar::gpb::RepString>(
            Test::Etl::Scalar::RepString{.value = {"hello"}});
        gpb_compatibility<Test::Etl::Scalar::gpb::RepString>(
            Test::Etl::Scalar::RepString{.value = {"hello", "world"}});
    }
}
TEST_CASE("bool")
{
    ...
    SUBCASE("repeated")
    {
        ...
        gpb_compatibility<Test::Etl::Scalar::gpb::RepBool>(
            Test::Etl::Scalar::RepBool{.value = {true, false}});

        SUBCASE("packed")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::RepPackBool>(
                Test::Etl::Scalar::RepPackBool{.value = {true}});
            gpb_compatibility<Test::Etl::Scalar::gpb::RepPackBool>(
                Test::Etl::Scalar::RepPackBool{.value = {true, false}});
        }
    }
}
TEST_CASE("int")
{
    SUBCASE("varint32")
    {
        ...
        SUBCASE("repeated")
        {
            ...
            gpb_compatibility<Test::Etl::Scalar::gpb::RepInt32>(
                Test::Etl::Scalar::RepInt32{.value = {0x42, 0x3}});

            SUBCASE("packed")
            {
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackInt32>(
                    Test::Etl::Scalar::RepPackInt32{.value = {0x42}});
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackInt32>(
                    Test::Etl::Scalar::RepPackInt32{.value = {0x42, 0x3}});
            }
        }
    }
    SUBCASE("varint64")
    {
        ...
        SUBCASE("repeated")
        {
            ...
            gpb_compatibility<Test::Etl::Scalar::gpb::RepInt64>(
                Test::Etl::Scalar::RepInt64{.value = {0x42, 0x3}});

            SUBCASE("packed")
            {
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackInt64>(
                    Test::Etl::Scalar::RepPackInt64{.value = {0x42}});
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackInt64>(
                    Test::Etl::Scalar::RepPackInt64{.value = {0x42, 0x3}});
            }
        }
    }
    SUBCASE("svarint32")
    {
        ...
        SUBCASE("repeated")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::RepSint32>(
                Test::Etl::Scalar::RepSint32{.value = {0x42}});
            gpb_compatibility<Test::Etl::Scalar::gpb::RepSint32>(
                Test::Etl::Scalar::RepSint32{.value = {0x42, -2}});

            SUBCASE("packed")
            {
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackSint32>(
                    Test::Etl::Scalar::RepPackSint32{.value = {0x42}});
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackSint32>(
                    Test::Etl::Scalar::RepPackSint32{.value = {0x42, -2}});
            }
        }
    }
    SUBCASE("svarint64")
    {
        ...
        SUBCASE("repeated")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::RepSint64>(
                Test::Etl::Scalar::RepSint64{.value = {0x42}});
            gpb_compatibility<Test::Etl::Scalar::gpb::RepSint64>(
                Test::Etl::Scalar::RepSint64{.value = {0x42, -2}});

            SUBCASE("packed")
            {
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackSint64>(
                    Test::Etl::Scalar::RepPackSint64{.value = {0x42}});
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackSint64>(
                    Test::Etl::Scalar::RepPackSint64{.value = {0x42, -2}});
            }
        }
    }
    SUBCASE("fixed32")
    {
        SUBCASE("required")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqFixed32>(
                Test::Etl::Scalar::ReqFixed32{.value = 0x42});
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqFixed32>(
                Test::Etl::Scalar::ReqFixed32{.value = 0xff});
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqFixed32>(
                Test::Etl::Scalar::ReqFixed32{.value = uint32_t(-2)});
        }
        SUBCASE("optional")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::OptFixed32>(
                Test::Etl::Scalar::OptFixed32{.value = 0x42});
            gpb_compatibility<Test::Etl::Scalar::gpb::OptFixed32>(
                Test::Etl::Scalar::OptFixed32{.value = 0xff});
            gpb_compatibility<Test::Etl::Scalar::gpb::OptFixed32>(Test::Etl::Scalar::OptFixed32{.value = -2});
        }
        SUBCASE("repeated")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::RepFixed32>(
                Test::Etl::Scalar::RepFixed32{.value = {0x42}});
            gpb_compatibility<Test::Etl::Scalar::gpb::RepFixed32>(
                Test::Etl::Scalar::RepFixed32{.value = {0x42, 0x3}});

            SUBCASE("packed")
            {
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackFixed32>(
                    Test::Etl::Scalar::RepPackFixed32{.value = {0x42}});
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackFixed32>(
                    Test::Etl::Scalar::RepPackFixed32{.value = {0x42, 0x3}});
            }
        }
    }
    SUBCASE("fixed64")
    {
        SUBCASE("required")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqFixed64>(
                Test::Etl::Scalar::ReqFixed64{.value = 0x42});
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqFixed64>(
                Test::Etl::Scalar::ReqFixed64{.value = 0xff});
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqFixed64>(
                Test::Etl::Scalar::ReqFixed64{.value = uint64_t(-2)});
        }
        SUBCASE("optional")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::OptFixed64>(
                Test::Etl::Scalar::OptFixed64{.value = 0x42});
            gpb_compatibility<Test::Etl::Scalar::gpb::OptFixed64>(
                Test::Etl::Scalar::OptFixed64{.value = 0xff});
            gpb_compatibility<Test::Etl::Scalar::gpb::OptFixed64>(Test::Etl::Scalar::OptFixed64{.value = -2});
        }
        SUBCASE("repeated")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::RepFixed64>(
                Test::Etl::Scalar::RepFixed64{.value = {0x42}});
            gpb_compatibility<Test::Etl::Scalar::gpb::RepFixed64>(
                Test::Etl::Scalar::RepFixed64{.value = {0x42, 0x3}});
            SUBCASE("packed")
            {
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackFixed64>(
                    Test::Etl::Scalar::RepPackFixed64{.value = {0x42}});
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackFixed64>(
                    Test::Etl::Scalar::RepPackFixed64{.value = {0x42, 0x3}});
            }
        }
    }
    SUBCASE("sfixed32")
    {
        SUBCASE("required")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqSfixed32>(
                Test::Etl::Scalar::ReqSfixed32{.value = 0x42});
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqSfixed32>(
                Test::Etl::Scalar::ReqSfixed32{.value = 0xff});
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqSfixed32>(
                Test::Etl::Scalar::ReqSfixed32{.value = -2});
        }
        SUBCASE("optional")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::OptSfixed32>(
                Test::Etl::Scalar::OptSfixed32{.value = 0x42});
            gpb_compatibility<Test::Etl::Scalar::gpb::OptSfixed32>(
                Test::Etl::Scalar::OptSfixed32{.value = 0xff});
            gpb_compatibility<Test::Etl::Scalar::gpb::OptSfixed32>(
                Test::Etl::Scalar::OptSfixed32{.value = -2});
        }
        SUBCASE("repeated")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::RepSfixed32>(
                Test::Etl::Scalar::RepSfixed32{.value = {0x42}});
            gpb_compatibility<Test::Etl::Scalar::gpb::RepSfixed32>(
                Test::Etl::Scalar::RepSfixed32{.value = {0x42, 0x3}});

            SUBCASE("packed")
            {
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackSfixed32>(
                    Test::Etl::Scalar::RepPackSfixed32{.value = {0x42}});
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackSfixed32>(
                    Test::Etl::Scalar::RepPackSfixed32{.value = {0x42, 0x3}});
            }
        }
    }
    SUBCASE("sfixed64")
    {
        SUBCASE("required")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqSfixed64>(
                Test::Etl::Scalar::ReqSfixed64{.value = 0x42});
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqSfixed64>(
                Test::Etl::Scalar::ReqSfixed64{.value = 0xff});
            gpb_compatibility<Test::Etl::Scalar::gpb::ReqSfixed64>(
                Test::Etl::Scalar::ReqSfixed64{.value = -2});
        }
        SUBCASE("optional")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::OptSfixed64>(
                Test::Etl::Scalar::OptSfixed64{.value = 0x42});
            gpb_compatibility<Test::Etl::Scalar::gpb::OptSfixed64>(
                Test::Etl::Scalar::OptSfixed64{.value = 0xff});
            gpb_compatibility<Test::Etl::Scalar::gpb::OptSfixed64>(
                Test::Etl::Scalar::OptSfixed64{.value = -2});
        }
        SUBCASE("repeated")
        {
            gpb_compatibility<Test::Etl::Scalar::gpb::RepSfixed64>(
                Test::Etl::Scalar::RepSfixed64{.value = {0x42}});
            gpb_compatibility<Test::Etl::Scalar::gpb::RepSfixed64>(
                Test::Etl::Scalar::RepSfixed64{.value = {0x42, 0x3}});

            SUBCASE("packed")
            {
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackSfixed64>(
                    Test::Etl::Scalar::RepPackSfixed64{.value = {0x42}});
                gpb_compatibility<Test::Etl::Scalar::gpb::RepPackSfixed64>(
                    Test::Etl::Scalar::RepPackSfixed64{.value = {0x42, 0x3}});
            }
        }
    }
}
TEST_CASE("float")
{
    ...
    SUBCASE("repeated")
    {
        ...
        gpb_compatibility<Test::Etl::Scalar::gpb::RepFloat>(
            Test::Etl::Scalar::RepFloat{.value = {42.0, 42.3}});
    }
}
TEST_CASE("double")
{
    ...
    SUBCASE("repeated")
    {
        ...
        gpb_compatibility<Test::Etl::Scalar::gpb::RepDouble>(
            Test::Etl::Scalar::RepDouble{.value = {42.3, 3.0}});
    }
}
TEST_CASE("bytes")
{
    SUBCASE("required")
    {
        gpb_compatibility<Test::Etl::Scalar::gpb::ReqBytes>(
            Test::Etl::Scalar::ReqBytes{.value = to_bytes("hello")});
        gpb_compatibility<Test::Etl::Scalar::gpb::ReqBytes>(
            Test::Etl::Scalar::ReqBytes{.value = to_bytes("\x00\x01\x02"sv)});
        gpb_compatibility<Test::Etl::Scalar::gpb::ReqBytes>(
            Test::Etl::Scalar::ReqBytes{.value = to_bytes("\x00\x01\x02\x03\x04"sv)});
    }
    SUBCASE("optional")
    {
        gpb_compatibility<Test::Etl::Scalar::gpb::OptBytes>(
            Test::Etl::Scalar::OptBytes{.value = to_bytes("hello")});
        gpb_compatibility<Test::Etl::Scalar::gpb::OptBytes>(
            Test::Etl::Scalar::OptBytes{.value = to_bytes("\x00\x01\x02"sv)});
        gpb_compatibility<Test::Etl::Scalar::gpb::OptBytes>(
            Test::Etl::Scalar::OptBytes{.value = to_bytes("\x00\x01\x02\x03\x04"sv)});
    }
    SUBCASE("repeated")
    {
        gpb_compatibility<Test::Etl::Scalar::gpb::RepBytes>(
            Test::Etl::Scalar::RepBytes{.value = {to_bytes("hello")}});
        gpb_compatibility<Test::Etl::Scalar::gpb::RepBytes>(
            Test::Etl::Scalar::RepBytes{.value = {to_bytes("\x00\x01\x02"sv)}});
        gpb_compatibility<Test::Etl::Scalar::gpb::RepBytes>(
            Test::Etl::Scalar::RepBytes{.value = {to_bytes("\x00\x01\x02\x03\x04"sv)}});
    }
}
TEST_CASE("person")
{
