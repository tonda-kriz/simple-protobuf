    ...
    SUBCASE( "bool" )
    {
        ...
        SUBCASE( "repeated" )
        {
            ...
            SUBCASE( "packed" )
            {
                ...
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::RepPackBool >( "\x0a\x02\x08"sv ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::RepPackBool >( "\x0a\x01\x08"sv ) );
            }
        }
    }
    SUBCASE( "int" )
    {
        ...
        SUBCASE( "varuint32" )
        {
            SUBCASE( "required" )
            {
                ...
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::ReqUint32 >( "\x08" ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::ReqUint32 >( "\x08\xff" ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::ReqUint32 >( "\x08\xff\xff\xff\xff\xff\x0f" ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::ReqUint32 >( "\x08\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01" ) );
            }
            SUBCASE( "optional" )
            {
            ...
            SUBCASE( "repeated" )
            {
                ...
                SUBCASE( "packed" )
                {
                    ...
                    CHECK_THROWS( spb::pb::deserialize< Test::Scalar::RepPackUint32 >( "\x0a\x02\x42" ) );
                    CHECK_THROWS( spb::pb::deserialize< Test::Scalar::RepPackUint32 >( "\x0a\x02\x42\xff" ) );
                }
            }
        }
        SUBCASE( "varint64" )
    ...
    SUBCASE( "ignore" )
    {
        SUBCASE( "string" )
        {
            SUBCASE( "required" )
            {
                ...
                CHECK_NOTHROW( spb::pb::deserialize< Test::Scalar::Empty >( "\x0a\x05hello"sv ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x0a\x05hell"sv ) );
            }
            SUBCASE( "repeated" )
            {
                CHECK( spb::pb::deserialize< Test::Scalar::Simple >( "\x0a\x05hello\x0a\x05world"sv ) == Test::Scalar::Simple{ } );
                CHECK_NOTHROW( spb::pb::deserialize< Test::Scalar::Empty >( "\x0a\x05hello\x0a\x05world"sv ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x0a\x05hello\x0a\x05worl"sv ) );
            }
        }
        SUBCASE( "bool" )
        {
            ...
            SUBCASE( "repeated" )
            {
                ...
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x08\x01\x08"sv ) );
            }
        }
        SUBCASE( "int" )
        {
            SUBCASE( "varint32" )
            {
                SUBCASE( "required" )
                {
                    ...
                    CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x08" ) );
                    CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x08\xff" ) );
                    CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x08\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01" ) );
                }
                SUBCASE( "repeated" )
                {
                    ...
                    SUBCASE( "packed" )
                    {
                        ...
                        CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x0a\x02\x42" ) );
                    }
                }
            }
            SUBCASE( "varint64" )
            ...
            SUBCASE( "svarint64" )
            {
                ...
                SUBCASE( "repeated" )
                {
                    ...
                    SUBCASE( "packed" )
                    {
                        ...
                        CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x0a\x02\x84"sv ) );
                        CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x0a\x03\x84\x01"sv ) );
                    }
                }
            }
            SUBCASE( "fixed32" )
            {
                SUBCASE( "required" )
                {
                    ...
                    CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x0d\x42\x00\x00"sv ) );
                }
                SUBCASE( "repeated" )
                {
                    CHECK( spb::pb::deserialize< Test::Scalar::Simple >( "\x0d\x42\x00\x00\x00"sv ) == Test::Scalar::Simple{ } );
                    ...
                    SUBCASE( "packed" )
                    {
                        ...
                        CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x0a\x08\x42\x00\x00\x00\x03\x00\x00"sv ) );
                    }
                }
            }
            SUBCASE( "fixed64" )
            {
                SUBCASE( "required" )
                {
                    ...
                    CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x09\x42\x00\x00\x00\x00\x00\x00"sv ) );
                }
                SUBCASE( "repeated" )
                {
                    CHECK( spb::pb::deserialize< Test::Scalar::Simple >( "\x09\x42\x00\x00\x00\x00\x00\x00\x00"sv ) == Test::Scalar::Simple{ } );
        ...
        SUBCASE( "float" )
        {
            SUBCASE( "required" )
            {
                ...
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x0d\x00\x00\x28"sv ) );
            }
            SUBCASE( "repeated" )
            {
        ...
        SUBCASE( "struct" )
        {
            ...
            CHECK_NOTHROW( spb::pb::deserialize< Test::Scalar::Empty >( "\x0a\x08John Doe\x10\x7b\x1a\x11QXUeh@example.com\x22\x0c\x0A\x08"
                                                                        "555-4321\x10\x01"sv ) );
        }
        SUBCASE( "invalid" )
        {
            SUBCASE( "wire type" )
            {
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::OptInt32 >( "\x0a\x05hello"sv ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::OptInt32 >( "\x0d\x00\x00\x28\x42"sv ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::OptString >( "\x0d\x00\x00\x28\x42"sv ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x0f\x05hello"sv ) );
            }
            SUBCASE( "stream" )
            {
                CHECK_THROWS( spb::pb::deserialize< Test::Recursive >( "\x0a\x05\x0a\x05hello"sv ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Recursive >( "\x0a\x08\x0a\x05hello"sv ) );
            }
            SUBCASE( "tag" )
            {
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\xff\xff\xff\xff\xff\xff\xff\xff\x01"sv ) );
                CHECK_THROWS( spb::pb::deserialize< Test::Scalar::Empty >( "\x07\x05hello"sv ) );
            }
        }
    }
}
